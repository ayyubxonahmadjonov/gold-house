                ...
                SelectableRow(
                  onBusinessChanged: (business) {
                    setState(() {
                      ...
                      carouselKey =
                          UniqueKey(); // Refresh carousel on business change
          ...
          child: SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Center(child: VideoWidget(url: state.videos[index].video));
              },
            ),
          ),
        ),
  ...
  listener: (context, state) {
    if (state is VideosError) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to load videos: ${state.message}')),
      );
    }
  },
),   
                                        ...
                                        onTap: () {
                                          if (product.isAvailable) {
                                            ...
                                            CustomAwesomeDialog.showInfoDialog(
                                              context,
                                              title:
                                                  "Mahsulot mavjud emas".tr(),
                                              desc:
                                                  "Afsuski bu mahsulot Omborda qolmadi. Tez orada biz uni olib kelamiz"
                                                      .tr(),
                                            );
                                          }
                                        },
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  ValueListenableBuilder(
                                                    ...
                                                    builder: (
                                                      context,
                                                      Box<FavoriteProductModel>
                                                      box,
                                                      _,
                                                    ) {
                                                      final isFavorite = box
                                                          .containsKey(
                                                            product.id
                                                                .toString(),
                                                          );
